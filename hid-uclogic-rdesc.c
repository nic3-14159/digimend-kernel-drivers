...
const __u8 uclogic_rdesc_xppen_star06_pen_arr[] = {
	0x05, 0x0D,         /*  Usage Page (Digitizer),                 */
	0x09, 0x02,         /*  Usage (Pen),                            */
	0xA1, 0x01,         /*  Collection (Application),               */
...
const size_t uclogic_rdesc_xppen_star06_pen_size =
			sizeof(uclogic_rdesc_xppen_star06_pen_arr);

/* Report descriptor template for XP-Pen Star 06 frame */
const __u8 uclogic_rdesc_xppen_star06_frame_arr[] = {
	0x05, 0x01,         /*  Usage Page (Desktop),               */
	0x09, 0x07,         /*  Usage (Keypad),                     */
	0xA1, 0x01,         /*  Collection (Application),           */
...
const size_t uclogic_rdesc_xppen_star06_frame_size =
			sizeof(uclogic_rdesc_xppen_star06_frame_arr);
